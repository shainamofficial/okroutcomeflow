...
interface InitiativeFiltersProps {
  filters: InitiativeFiltersState;
  onFiltersChange: (filters: InitiativeFiltersState) => void;
}

export function InitiativeFilters({ filters, onFiltersChange }: InitiativeFiltersProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 p-4 border rounded-lg bg-muted/30">
      ...
      <Select
        ...
        onValueChange={(v) => onFiltersChange({ ...filters, status: v as InitiativeFiltersState["status"] })}
      >
